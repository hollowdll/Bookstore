...
public class BookstoreApplication {
	...
	public CommandLineRunner studentDemo(BookRepository bookRepository, CategoryRepository categoryRepository) {
		return (args) -> {
			...
			bookRepository.save(new Book("Test book", "Test author", "123-456-789", 1999, 40, categoryRepository.findByName("Horror").get(0)));
			bookRepository.save(new Book("Test book 2", "Test author 2", "987-654-00", 2000, 35, categoryRepository.findByName("Fantasy").get(0)));
			bookRepository.save(new Book("Scam book", "Scammer123", "123123-123", 2023, 666.666, categoryRepository.findByName("Romance").get(0)));
			bookRepository.save(new Book("Software Engineering", "Author123", "999-666-333", 2015, 45, categoryRepository.findByName("Science").get(0)));
